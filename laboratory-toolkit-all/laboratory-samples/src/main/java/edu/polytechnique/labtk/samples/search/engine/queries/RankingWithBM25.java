...
import edu.polytechnique.labtk.samples.search.engine.termsindex.CalculatingInvertedTermFrequency;
import edu.polytechnique.labtk.samples.search.engine.termsindex.ComputingAverageDocumentLength;
import edu.polytechnique.labtk.samples.search.engine.termsindex.CountingTermsOccurencesInEachDocument;
...
import edu.polytechnique.labtk.samples.search.engine.termsindex.TermWeight;
import edu.polytechnique.labtk.samples.search.engine.termsindex.TermsIndexingEquipment;
import edu.polytechnique.labtk.samples.search.engine.termsindex.TermsOccurences;
